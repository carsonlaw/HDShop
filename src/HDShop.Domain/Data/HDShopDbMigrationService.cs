...
{
    public class HDShopDbMigrationService : ITransientDependency
    {
        public ILogger<HDShopDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IHDShopDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public HDShopDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IHDShopDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<HDShopDbMigrationService>.Instance;
        }

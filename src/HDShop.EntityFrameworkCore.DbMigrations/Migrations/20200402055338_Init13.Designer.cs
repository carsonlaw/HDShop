...
namespace HDShop.Migrations
{
    ...
    [Migration("20200402055338_Init13")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HDShop.Orders.OrderDeliverAddressMap", b =>
                {
                    ...
                    b.HasKey("DeliverAddressId", "OrderId");

                    b.HasIndex("OrderId")
                        .IsUnique();

                    b.ToTable("HDOrderDeliverAddressMap");
                });
            ...
            modelBuilder.Entity("HDShop.Orders.OrderDeliverAddressMap", b =>
                {
                    b.HasOne("HDShop.Orders.Order", null)
                        .WithOne("DeliverAddressMap")
                        .HasForeignKey("HDShop.Orders.OrderDeliverAddressMap", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("HDShop.Orders.OrderLine", b =>
                {
                    b.HasOne("HDShop.Goods.GoodSku", "GoodSku")
                        .WithMany()
                        .HasForeignKey("GoodSkuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false),
                    Code = table.Column<string>(type: "varchar(20) CHARACTER SET utf8mb4", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false),
                    Name = table.Column<string>(type: "varchar(100) CHARACTER SET utf8mb4", maxLength: 100, nullable: false),
                    SubName = table.Column<string>(type: "varchar(300) CHARACTER SET utf8mb4", maxLength: 300, nullable: false),
                    Code = table.Column<string>(type: "varchar(30) CHARACTER SET utf8mb4", maxLength: 30, nullable: false),
                    Description = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: false),
                    ImageBaseUrl = table.Column<string>(type: "varchar(100) CHARACTER SET utf8mb4", maxLength: 100, nullable: false),
                    ImageUrls = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: false),
                    SaleStates_IsHot = table.Column<bool>(type: "tinyint(1)", nullable: true),
                    SaleStates_IsNew = table.Column<bool>(type: "tinyint(1)", nullable: true),
                    SaleStates_IsDiscount = table.Column<bool>(type: "tinyint(1)", nullable: true),
                    SaleStates_IsRecommand = table.Column<bool>(type: "tinyint(1)", nullable: true),
                    ExtraProperties = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "varchar(40) CHARACTER SET utf8mb4", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CreatorId = table.Column<Guid>(type: "char(36)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoodDescription = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", maxLength: 8000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentGoodPropertyId = table.Column<Guid>(type: "char(36)", nullable: true),
                    ExtraProperties = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "varchar(40) CHARACTER SET utf8mb4", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CreatorId = table.Column<Guid>(type: "char(36)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false),
                    Name = table.Column<string>(type: "varchar(10) CHARACTER SET utf8mb4", maxLength: 10, nullable: false),
                    Phone = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: false),
                    Address = table.Column<string>(type: "varchar(10) CHARACTER SET utf8mb4", maxLength: 10, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CreatorId = table.Column<Guid>(type: "char(36)", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "char(36)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumSalesReal = table.Column<int>(type: "int", nullable: false),
                    Weight = table.Column<int>(type: "int", nullable: false),
                    Stock = table.Column<int>(type: "int", nullable: false),
                    GoodId = table.Column<Guid>(type: "char(36)", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CreatorId = table.Column<Guid>(type: "char(36)", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "char(36)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "GoodGoodCategory",
                columns: table => new
                {
                    GoodCategorysId = table.Column<Guid>(type: "char(36)", nullable: false),
                    GoodsId = table.Column<Guid>(type: "char(36)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GoodGoodCategory", x => new { x.GoodCategorysId, x.GoodsId });
                    table.ForeignKey(
                        name: "FK_GoodGoodCategory_HDGood_GoodsId",
                        column: x => x.GoodsId,
                        principalTable: "HDGood",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GoodGoodCategory_HDGoodCategory_GoodCategorysId",
                        column: x => x.GoodCategorysId,
                        principalTable: "HDGoodCategory",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GoodPropertiesId = table.Column<Guid>(type: "char(36)", nullable: false),
                    GoodsId = table.Column<Guid>(type: "char(36)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GoodGoodProperty", x => new { x.GoodPropertiesId, x.GoodsId });
                    table.ForeignKey(
                        name: "FK_GoodGoodProperty_HDGood_GoodsId",
                        column: x => x.GoodsId,
                        principalTable: "HDGood",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GoodGoodProperty_HDGoodProperty_GoodPropertiesId",
                        column: x => x.GoodPropertiesId,
                        principalTable: "HDGoodProperty",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliverAddressId = table.Column<Guid>(type: "char(36)", nullable: true),
                    PayOrder_Code = table.Column<string>(type: "varchar(20) CHARACTER SET utf8mb4", maxLength: 20, nullable: true),
                    PayOrder_PayPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    PayOrder_CreationTime = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    DeliverOrder_Code = table.Column<string>(type: "varchar(20) CHARACTER SET utf8mb4", maxLength: 20, nullable: true),
                    DeliverOrder_DeliverCompanyId = table.Column<Guid>(type: "char(36)", nullable: true),
                    DeliverOrder_CreationTime = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    ExtraProperties = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "varchar(40) CHARACTER SET utf8mb4", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CreatorId = table.Column<Guid>(type: "char(36)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HDOrder_HDDeliverAddress_DeliverAddressId",
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.DeliverOrder_DeliverCompanyId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GoodSkuId = table.Column<Guid>(type: "char(36)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HDOrderLine", x => new { x.OrderId, x.GoodSkuId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GoodGoodCategory_GoodsId",
                table: "GoodGoodCategory",
                column: "GoodsId");

            migrationBuilder.CreateIndex(
                name: "IX_GoodGoodProperty_GoodsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HDOrder_DeliverAddressId",
                table: "HDOrder",

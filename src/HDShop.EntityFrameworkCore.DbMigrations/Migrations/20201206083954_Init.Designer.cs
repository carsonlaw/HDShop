...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoodGoodCategory", b =>
                {
                    b.Property<Guid>("GoodCategorysId")
                        .HasColumnType("char(36)");

                    b.Property<Guid>("GoodsId")
                        .HasColumnType("char(36)");

                    b.HasKey("GoodCategorysId", "GoodsId");

                    b.HasIndex("GoodsId");

                    b.ToTable("GoodGoodCategory");
                });

            modelBuilder.Entity("GoodGoodProperty", b =>
                {
                    b.Property<Guid>("GoodPropertiesId")
                        .HasColumnType("char(36)");

                    b.Property<Guid>("GoodsId")
                        .HasColumnType("char(36)");

                    b.HasKey("GoodPropertiesId", "GoodsId");
            ...
            modelBuilder.Entity("HDShop.Orders.DeliverAddress", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("HDDeliverAddress");
                });

            modelBuilder.Entity("HDShop.Orders.DeliverCompany", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("HDShop.Orders.Order", b =>
                {
                    ...
                    b.Property<Guid?>("DeliverAddressId")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("HDShop.Orders.OrderLine", b =>
                {
                    b.Property<Guid>("OrderId")
                        .HasColumnType("char(36)");

                    b.Property<Guid>("GoodSkuId")
                        .HasColumnType("char(36)");
                    ...
                    b.HasKey("OrderId", "GoodSkuId");

                    b.ToTable("HDOrderLine");
                });

            modelBuilder.Entity("HDShop.Orders.PayCompany", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("HDPayCompany");
                });

            modelBuilder.Entity("HDShop.Users.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("GoodGoodCategory", b =>
                {
                    b.HasOne("HDShop.Goods.GoodCategory", null)
                        .WithMany()
                        .HasForeignKey("GoodCategorysId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HDShop.Goods.Good", null)
                        .WithMany()
            ...
            modelBuilder.Entity("GoodGoodProperty", b =>
                {
                    b.HasOne("HDShop.Goods.GoodProperty", null)
                        .WithMany()
                        .HasForeignKey("GoodPropertiesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HDShop.Goods.GoodProperty", b =>
                {
                    ...
                    b.Navigation("ParentGoodProperty");
                });
            ...
            modelBuilder.Entity("HDShop.Orders.Order", b =>
                {
                    ...
                    b.HasOne("HDShop.Orders.DeliverAddress", "DeliverAddress")
                        .WithMany()
                    ...
                    b.OwnsOne("HDShop.Orders.DeliverOrder", "DeliverOrder", b1 =>
                        {
                            ...
                            b1.Property<Guid?>("DeliverCompanyId")
                                .HasColumnType("char(36)");

                            b1.HasKey("OrderId");

                            b1.HasIndex("DeliverCompanyId");

                            b1.ToTable("HDOrder");

                            b1.HasOne("HDShop.Orders.DeliverCompany", "DeliverCompany")
                                .WithMany()
                            ...
                            b1.Navigation("DeliverCompany");
                        });

                    b.OwnsOne("HDShop.Orders.PayOrder", "PayOrder", b1 =>
                        {
                            b1.Property<Guid>("OrderId")
                                .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("HDShop.Orders.OrderLine", b =>
                {
                    b.HasOne("HDShop.Orders.Order", null)
                        .WithMany("OrderLines")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HDShop.Users.AppUser", b =>
                {
                    b.HasOne("Volo.Abp.Identity.IdentityUser", null)
                        .WithOne()
                        .HasForeignKey("HDShop.Users.AppUser", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("HDShop.Goods.Good", b =>
                {
                    b.Navigation("GoodSkus");
                });

            modelBuilder.Entity("HDShop.Goods.GoodCategory", b =>
                {
                    b.Navigation("ChildCategorys");
                });

            modelBuilder.Entity("HDShop.Goods.GoodProperty", b =>
                {
                    b.Navigation("ChildGoodProperties");
                });
